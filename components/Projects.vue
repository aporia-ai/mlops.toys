  ...
  <div id="projects" class="projects">
        ...
        <Container class="flex items-center justify-between lg:block">
          ...
          >
            ...
            <div class="ml-4">
              ...
              <div class="text-xs text-gray-400 text-right -mt-1.5">
                by Aporia
              </div>
            </div>
          </a>
    ...
    >
      ...
      <div
        ...
        class="transition-runner hidden"
      ></div>
    </Container>
  </div>
</template>
  ...
  methods: {
    toggleCategory(categoryName) {
      const isCategorySelected =
        this.selectedCategoriesVisual.length > 0 &&
        this.selectedCategoriesVisual[0] === categoryName
    ...
    checkHeaderScrollPosition() {
      ...
      const maxScroll =
        this.$refs?.header?.scrollWidth - this.$refs?.header?.offsetWidth
